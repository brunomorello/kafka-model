package pt.bmo.launcher;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import pt.bmo.MessageProducer;
...
import static pt.bmo.MessageProducer.propertiesMap;
...
public class CommandLineLauncher {
    ...
    public static MessageProducer init(){
        ...
        Map<String, Object> producerProps = propertiesMap();
    ...
    public static void publishMessage(MessageProducer messageProducer, String input){
        ...
        switch (noOfTokens){
            case 1:
                messageProducer.publishMsgSync(null,stringTokenizer.nextToken());
                break;
            case 2:
                messageProducer.publishMsgSync(stringTokenizer.nextToken(),stringTokenizer.nextToken());
                break;
            default:
                break;
        }
